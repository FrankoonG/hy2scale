...
//
// Routing model: there is NO "DNS exit pin". Each rule's DNS naturally
// rides the same exit as its data — `exit_via=us` rules resolve through
// us, `exit_via=jp` rules resolve through jp. The wire-level mechanism
